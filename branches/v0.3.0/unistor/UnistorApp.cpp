...
CWX_UINT32 UnistorApp::packMonitorInfo(){
	...
	do{
        ...
        //cache的key的数量
        CwxCommon::snprintf(szLine, 4096, "STAT read_cache_key %u\r\n",
            m_store->getStoreEngine()->getCache()->getReadCacheKeyNum());
        UNISTOR_MONITOR_APPEND();
        //cache的key的空间
        CwxCommon::snprintf(szLine, 4096, "STAT read_cache_space %u\r\n",
            m_store->getStoreEngine()->getCache()->getReadCacheUsedSize());
        UNISTOR_MONITOR_APPEND();
        //cache的write key的数量
