...
#define UNISTOR_MAX_DATA_SIZE              4 * 1024 * 1024 ///<最大的DATA大小
#define UNISTOR_MAX_KEY_SIZE               1024            ///<最大的key的大小
#define UNISTOR_MAX_KV_SIZE				  (4 * 1024 * 1024 +  8 * 1024) ///<最大的data size
...
#define  UNISTOR_DEF_STORE_FLUSH_NUM  1000  ///<unistor存储触发flush的缺省数据变更数量
#define  UNISTOR_MIN_STORE_FLUSH_NUM  1     ///<unistor存储触发flush的最小数据变更数量
#define  UNISTOR_MAX_STORE_FLUSH_NUM  500000 ///<unistor存储触发flush的最大数据变更数量
