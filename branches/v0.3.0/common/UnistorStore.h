...
public:
    ...
    {
		return m_impl->createCursor(cursor, field, extra, szErr2K);
	}
    ...
    inline int appendTimeStampBinlog(CwxPackageWriter& writer, ///<writer对象
    ...
    {
        return m_impl->isValidSubscribe(subscribe, strErrMsg);
    }
